...
type Chunk<
    T extends Reindeer[][][],
    Column1 extends Reindeer[][] = Transpose<T>[0],
    Column2 extends Reindeer[][] = Transpose<T>[1],
    Column3 extends Reindeer[][] = Transpose<T>[2]> =
    [
        [Column1[0], Column1[1], Column1[2]],
        [Column2[0], Column2[1], Column2[2]],
        [Column3[0], Column3[1], Column3[2]],
        [Column1[3], Column1[4], Column1[5]],
        [Column2[3], Column2[4], Column2[5]],
        [Column3[3], Column3[4], Column3[5]],
        [Column1[6], Column1[7], Column1[8]],
        [Column2[6], Column2[7], Column2[8]],
        [Column3[6], Column3[7], Column3[8]],
    ]

type ChunkTest1 = Chunk<[
    //   ^?
    [['💨', '💃', '🦌'], ['☄️', '❤️', '🌩️'], ['🌟', '⚡', '🔴']],
    [['🌟', '⚡', '🔴'], ['💨', '💃', '🦌'], ['☄️', '❤️', '🌩️']],
    [['☄️', '❤️', '🌩️'], ['🌟', '⚡', '🔴'], ['💨', '💃', '🦌']],
...
type Validate<T extends Reindeer[][][]> =
    ...
    ? ValidateRow<Chunk<T>[number]> extends true
    ? true
    : false
    : false
    : false;
